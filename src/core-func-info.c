...
static mrp_debug_info_t info_0[] = {
    ...
    { .line = 263, .func = "mrp_console_vprintf" },
    { .line = 276, .func = "mrp_set_console_prompt" },
    { .line = 303, .func = "find_group" },
    { .line = 329, .func = "find_command" },
    { .line = 355, .func = "mrp_console_add_group" },
    { .line = 382, .func = "mrp_console_del_group" },
    { .line = 393, .func = "mrp_console_add_core_group" },
    { .line = 420, .func = "mrp_console_del_core_group" },
    { .line = 431, .func = "console_grab_output" },
    { .line = 454, .func = "console_release_output" },
    { .line = 473, .func = "console_read_output" },
    { .line = 479, .func = "raw_argument" },
    { .line = 504, .func = "input_evt" },
    { .line = 674, .func = "disconnected_evt" },
    { .line = 680, .func = "complete_evt" },
    { .line = 697, .func = "cookie_write" },
    { .line = 713, .func = "cookie_close" },
    { .line = 721, .func = "console_fopen" },
    { .line = 740, .func = "register_commands" },
    { .line = 746, .func = "unregister_commands" },
    { .line = 762, .func = "get_next_line" },
    { .line = 799, .func = "skip_whitespace" },
    { .line = 806, .func = "get_next_token" },
    { .line = 0, .func = NULL }
};
