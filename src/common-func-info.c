...
static mrp_debug_info_t info_9[] = {
    ...
    { .line = 588, .func = "field_type_name" },
    { .line = 641, .func = "mrp_msg_dump" },
    { .line = 776, .func = "mrp_msg_default_encode" },
    { .line = 928, .func = "mrp_msg_default_decode" },
    { .line = 1154, .func = "guarded_array_size" },
    { .line = 1193, .func = "counted_array_size" },
    { .line = 1210, .func = "get_array_size" },
    { .line = 1231, .func = "mrp_data_get_array_size" },
    { .line = 1237, .func = "get_blob_size" },
    { .line = 1264, .func = "mrp_data_get_blob_size" },
    { .line = 1270, .func = "check_and_init_array_descr" },
    { .line = 1303, .func = "mrp_msg_register_type" },
    { .line = 1360, .func = "mrp_msg_find_type" },
    { .line = 1380, .func = "cleanup_types" },
    { .line = 1388, .func = "mrp_data_encode" },
    { .line = 1553, .func = "member_type" },
    { .line = 1567, .func = "mrp_data_decode" },
    { .line = 1797, .func = "mrp_data_dump" },
    { .line = 1912, .func = "mrp_data_free" },
    { .line = 1947, .func = "mrp_msgbuf_write" },
    { .line = 1965, .func = "mrp_msgbuf_read" },
    { .line = 1972, .func = "mrp_msgbuf_cancel" },
    { .line = 1979, .func = "mrp_msgbuf_ensure" },
    { .line = 2005, .func = "mrp_msgbuf_reserve" },
