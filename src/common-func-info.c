...
static mrp_debug_info_t info_5[] = {
    ...
    { .line = 105, .func = "mrp_log_dump_mask" },
    { .line = 142, .func = "mrp_log_enable" },
    { .line = 152, .func = "mrp_log_disable" },
    { .line = 162, .func = "mrp_log_set_mask" },
    { .line = 172, .func = "find_target" },
    { .line = 188, .func = "mrp_log_set_target" },
    { .line = 230, .func = "mrp_log_get_target" },
    { .line = 236, .func = "mrp_log_get_targets" },
    { .line = 255, .func = "mrp_log_register_target" },
    { .line = 282, .func = "mrp_log_unregister_target" },
    { .line = 302, .func = "log_msgv" },
    { .line = 340, .func = "mrp_log_msgv" },
    { .line = 354, .func = "mrp_log_msg" },
    { .line = 372, .func = "set_default_logging" },
    { .line = 0, .func = NULL }
};
